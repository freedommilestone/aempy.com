...
export type WorldEntry = { id: string; kind: EntryKind; title: string; description: string; status: "Not started" | "In progress" | "Completed"; cover: string; updatedAt: string; sourceEpisodeId?: string; characterRole?: CharacterRole; characterState?: "Draft" | "Ready"; characterTraits?: string; characterProfile?: CharacterProfile };
