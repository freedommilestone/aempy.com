...
export default function Dashboard({ initialSection = "Create" }: { initialSection?: string }) {
  ...
  function openProject(draft: Draft) { setEditingId(draft.id);setIdea(draft.idea);setFormat(draft.format);setStyle(draft.style);setBuilt(false);setStep(0);navigate("Create");setMessage("Project opened. Build My Story saves your changes to this project."); }
